    ...
    <loading-view :loading="initialLoading">
        ...
        <div class="flex ">
            ...
            <div class="relative mb-6 h-9 flex-no-shrink">
                <icon
                    type="search"
                    class="absolute ml-3 search-icon-center text-70"
                />
                <label for="search">
                    <input
                        v-model="search"
                            ...
                            <ul class="list-reset">
                                ...
                                >
                                    <checkbox-input
                                        ...
                                        :text="l.language"
                                        :checked="
                                            selected.locales.includes(l.locale)
                                        "
        ...
        <template v-if="translations">
            ...
            >
                ...
                <div v-else class="my-3">
                    <editable-input
                        v-for="locale in selected.locales
                            .map((locale) => locale)
                            .sort()"
                        :key="locale"
                        :locale="locale"
